...
Response: a list of Services and their corresponding service version numbers deployed with the given SystemVersionNumber
```
...
*** How to run
The SpringBoot application can be run as a jar, or in IDE.

To run as a jar:

```
java -jar release-manager.jar --spring.profiles.active=local
```
